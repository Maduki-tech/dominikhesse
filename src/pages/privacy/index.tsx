    ...
    return (
        <>
            ...
            <div className="xl:px-96 py-12">
                <h1 className="text-4xl">Datenschutz­erklärung</h1>
                <h2 className="text-2xl py-3">1. Datenschutz auf einen Blick</h2>
                <h3 className="text-xl py-4">Allgemeine Hinweise</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Datenerfassung auf dieser Website</h3>{' '}
                <p>
                    <strong>
                ...
                <h3 className="text-xl py-4">Analyse-Tools und Tools von Dritt­anbietern</h3>{' '}
                <p>
                ...
                <h2 className="text-2xl py-3">2. Hosting und Content Delivery Networks (CDN)</h2>
                <h3 className="text-xl py-4">Externes Hosting</h3>{' '}
                <p>
                ...
                <h2 className="text-2xl py-3">3. Allgemeine Hinweise und Pflicht­informationen</h2>
                <h3 className="text-xl py-4">Datenschutz</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Hinweis zur verantwortlichen Stelle</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Hinweis zur Datenweitergabe in die USA</h3>{' '}
                <p>
                    Auf unserer Webseite sind unter anderem Tools von
                    Unternehmen mit Sitz in den USA eingebunden. Wenn diese
                    Tools aktiv sind, können Ihre personenbezogenen Daten an die
                    US-Server der jeweiligen Unternehmen weitergegeben werden.
                    Wir weisen darauf hin, dass die USA kein sicherer Drittstaat
                    im Sinne des EU-Datenschutzrechts sind. US-Unternehmen sind
                    ...
                    speichern. Wir haben auf diese Verarbeitungstätigkeiten
                    keinen Einfluss.
                </p>
                <h3 className="text-xl py-4">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Beschwerde­recht bei der zuständigen Aufsichts­behörde</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Recht auf Daten­übertrag­barkeit</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">SSL- bzw. TLS-Verschlüsselung</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Auskunft, Löschung und Berichtigung</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Recht auf Einschränkung der Verarbeitung</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Widerspruch gegen Werbe-E-Mails</h3>{' '}
                <p>
                ...
                <h2 className="text-2xl py-3">4. Datenerfassung auf dieser Website</h2>
                <h3 className="text-xl py-4">Cookies</h3>{' '}
                <p>
                    ...
                    Endgerät gespeichert, bis Sie diese selbst löschen&nbsp;oder
                ...
                <p>
                    ...
                    Cookies dienen dazu, das Nutzerverhalten
                ...
                <h3 className="text-xl py-4">Kontaktformular</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Anfrage per E-Mail, Telefon oder Telefax</h3>{' '}
                <p>
                ...
                <h2 className="text-2xl py-3">5. Newsletter</h2>
                <h3 className="text-xl py-4">Newsletter­daten</h3>{' '}
                <p>
                ...
                <p>
                    ...
                    Abbestellung des Newsletters aus der
                    Newsletterverteilerliste gelöscht. Daten, die zu anderen
                ...
                <p>
                    ...
                    gespeichert, um künftige Mailings zu verhindern. Die Daten
                    aus der Blacklist werden nur für diesen Zweck verwendet und
                    nicht mit anderen Daten zusammengeführt. Dies dient sowohl
                    Ihrem Interesse als auch unserem Interesse an der Einhaltung
                    der gesetzlichen Vorgaben beim Versand von Newslettern
                ...
                <h2 className="text-2xl py-3">6. Plugins und Tools</h2>
                <h3 className="text-xl py-4">YouTube</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Vimeo</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">Google Maps</h3>{' '}
                <p>
                ...
                <h3 className="text-xl py-4">DigiStore24</h3>{' '}
                <p>
                    Diese Seite nutzt für sämtlichen Zahlungsverkehr (Monatliche
                    Abbuchung der Mitgliedschaften sowie der Inanspruchnahme der
                    1-1-Online-Nachhilfe und 1-n-Online-Nachhilfe den Anbieter
                    DigiStore24, St.-Godehard-Str. 32, 31139 Hildesheim.
                </p>{' '}
                <p>
                    Mehr Informationen zum Umgang mit Nutzerdaten finden Sie in
                    der Datenschutzerklärung von DigiStore24:{' '}
                    <a
                        href="https://www.digistore24.com/de/info/privacy/1"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                ...
                <h3 className="text-xl py-4">Zoom</h3>{' '}
                <p>
                    Diese Website nutzt für Videokonferenzen (z.B.
                    1-1-Online-Nachhilfe und 1-n-Online-Nachhilfe) den Anbieter
                    Zoom, 55 Almaden Boulevard, 6th Floor, San Jose, CA 95113
                </p>{' '}
                <p>
                    Mehr Informationen zum Umgang mit Nutzerdaten finden Sie in
                    der Datenschutzerklärung von Zoom:{' '}
                    <a
                ...
                <p>
                    Quelle: <a href="https://www.e-recht24.de">e-recht24</a>
                </p>
            </div>
            <Footer />
        </>

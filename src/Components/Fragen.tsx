...
export default function Fragen() {
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:px-24 2xl:px-96 px-2 gap-8 place-items-center bg-gradient-to-br from-primary/80 via-lime-600/80 to-primary/80 py-8">
            <div>
